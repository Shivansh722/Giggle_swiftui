...
class PreferenceViewModel: ObservableObject {
    ...
    init() {
        self.PreferenceArray = [
            PreferenceModel(isSelected: false, title: "customer service"),
            PreferenceModel(isSelected: false, title: "Photography"),
            PreferenceModel(isSelected: false, title: "Hospitality "),
            PreferenceModel(isSelected: false, title: "Communication"),
            PreferenceModel(isSelected: false, title: "Marketing")
        ]
    }
